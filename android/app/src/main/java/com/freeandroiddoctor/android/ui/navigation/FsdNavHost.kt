...
import com.freeandroiddoctor.android.ui.apps.AppUsageScreen
import com.freeandroiddoctor.android.ui.apps.ApkExtractorScreen
import com.freeandroiddoctor.android.ui.apps.AppsScreen
import com.freeandroiddoctor.android.ui.apps.PermissionAuditScreen
import com.freeandroiddoctor.android.ui.apps.RarelyUsedScreen
import com.freeandroiddoctor.android.ui.assistant.AssistantScreen
import com.freeandroiddoctor.android.ui.backup.BackupScreen
import com.freeandroiddoctor.android.ui.battery.BatteryScreen
import com.freeandroiddoctor.android.ui.cache.HiddenCacheScreen
import com.freeandroiddoctor.android.ui.cleaner.CleanerScreen
import com.freeandroiddoctor.android.ui.cloudbackup.CloudBackupScreen
import com.freeandroiddoctor.android.ui.cloudbackup.RestoreWizardScreen
import com.freeandroiddoctor.android.ui.focus.FocusScreen
import com.freeandroiddoctor.android.ui.forecast.StorageForecastScreen
import com.freeandroiddoctor.android.ui.appcleaners.AppCleanersHubScreen
import com.freeandroiddoctor.android.ui.appcleaners.DiscordCleanerScreen
import com.freeandroiddoctor.android.ui.appcleaners.TelegramCleanerScreen
import com.freeandroiddoctor.android.ui.appcleaners.TikTokCleanerScreen
import com.freeandroiddoctor.android.ui.appcleaners.WhatsAppCleanerScreen
import com.freeandroiddoctor.android.ui.appdeep.AppDeepCleanScreen
import com.freeandroiddoctor.android.ui.battery.charging.ChargingLogScreen
import com.freeandroiddoctor.android.ui.battery.drain.BatteryDrainScreen
import com.freeandroiddoctor.android.ui.battery.health.BatteryHealthScreen
import com.freeandroiddoctor.android.ui.corpse.CorpseFinderScreen
import com.freeandroiddoctor.android.ui.gameboost.GameBoostScreen
import com.freeandroiddoctor.android.ui.history.CleaningHistoryScreen
import com.freeandroiddoctor.android.ui.notifications.stats.NotificationStatsScreen
import com.freeandroiddoctor.android.ui.storage.treemap.StorageTreemapScreen
import com.freeandroiddoctor.android.ui.insights.AppInsightsScreen
import com.freeandroiddoctor.android.ui.lock.AppLockScreen
import com.freeandroiddoctor.android.ui.resource.AppResourceScreen
import com.freeandroiddoctor.android.ui.tools.BatteryAlarmsScreen
import com.freeandroiddoctor.android.ui.trash.TrashScreen
import com.freeandroiddoctor.android.ui.vault.VaultScreen
import com.freeandroiddoctor.android.ui.memory.MemoryScreen
import com.freeandroiddoctor.android.ui.dashboard.DashboardScreen
import com.freeandroiddoctor.android.ui.device.DeviceInfoScreen
import com.freeandroiddoctor.android.ui.duplicates.DuplicatesScreen
import com.freeandroiddoctor.android.ui.files.FolderToolsScreen
import com.freeandroiddoctor.android.ui.files.ShredderScreen
import com.freeandroiddoctor.android.ui.largefiles.LargeFilesScreen
import com.freeandroiddoctor.android.ui.network.DataUsageScreen
import com.freeandroiddoctor.android.ui.network.SpeedTestScreen
import com.freeandroiddoctor.android.ui.network.WifiScreen
import com.freeandroiddoctor.android.ui.notifications.NotificationCleanerScreen
import com.freeandroiddoctor.android.ui.photos.CompressScreen
import com.freeandroiddoctor.android.ui.photos.PhotoReviewScreen
import com.freeandroiddoctor.android.ui.photos.SimilarPhotosScreen
import com.freeandroiddoctor.android.ui.components.ActiveModeChip
import com.freeandroiddoctor.android.ui.components.AnimatedBackdrop
import com.freeandroiddoctor.android.ui.components.BannerAd
import com.freeandroiddoctor.android.ui.components.UnlockSheetHost
import com.freeandroiddoctor.android.ui.pro.ProScreen
import com.freeandroiddoctor.android.ui.settings.SettingsScreen
import com.freeandroiddoctor.android.ui.storage.StorageByTypeScreen
import com.freeandroiddoctor.android.ui.storage.StorageScreen
import com.freeandroiddoctor.android.ui.system.ClipboardScreen
import com.freeandroiddoctor.android.ui.tools.ScheduleScreen
import com.freeandroiddoctor.android.ui.tools.SystemTweaksScreen
import com.freeandroiddoctor.android.ui.tools.ToolsScreen
...
private val toolTitles: Map<String, Int> = mapOf(
    ...
    ToolRoutes.TURBO to R.string.tool_turbo,
)
