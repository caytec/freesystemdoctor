...
def backup_network_config() -> dict:
    ...
    try:
        ...
        configs = {
            "ip_config": subprocess.run(["ipconfig"], capture_output=True, text=True, timeout=10).stdout,
            "dns_config": subprocess.run(["ipconfig", "/all"], capture_output=True, text=True, timeout=10).stdout,
            "route_table": subprocess.run(["route", "print"], capture_output=True, text=True, timeout=10).stdout,
        }
