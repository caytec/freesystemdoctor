package com.freeandroiddoctor.android.data.quota
 ...
 * Composable [com.freeandroiddoctor.android.ui.components.QuotaGate] handles the gating UX.
 *
...
class DailyQuotaStore(private val context: Context) {
     ...
     * watches a rewarded ad from the [com.freeandroiddoctor.android.ui.components.UnlockSheet]
