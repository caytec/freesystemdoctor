...
import com.freeandroiddoctor.android.core.util.Hashing
...
class HashingTest {
    ...
    fun sha256IsStableForSameContent() {
        val a = Hashing.sha256("freeandroiddoctor".byteInputStream())
        val b = Hashing.sha256("freeandroiddoctor".byteInputStream())
        assertEquals(a, b)
    }
